		...
		<!-- Phan dau -->
		 ...
		 <!-- Menu -->
			...
			<div class="nav">
				<ul id="menu">
					<li>
						<a id="menu-trang-chu" href="index.php" id="home">Trang chủ</a>
					</li>
					<li>
						<a id="menu-viec-lam" href="viec-lam.php">Việc làm</a>
					</li>
					<li>
						<a id="menu-viec-lam" href="nha-tuyen-dung.php">Nhà tuyển dụng</a>
					</li>
					<li>
						<a id="menu-lien-he" href="lien-he.php">Giới thiệu</a>
					</li>
				</ul>
			</div>
		</header>