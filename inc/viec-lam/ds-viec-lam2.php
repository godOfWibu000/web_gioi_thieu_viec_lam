<div class="vieclam p-1 col-lg-6 mb-2">
				...
				<?php
					if(isset($_SESSION["emailDangNhap"])){
						...
						if($quanTam->num_rows > 0){
							echo '
								<button style="width: 200px;" class="button button-create" onclick="boQuanTam(\''.$row['MaViecLam'].'\', \''.$_SESSION['emailDangNhap'].'\')">
							...
							echo '
								<button style="width: 200px;" class="button button-reset" onclick="quanTam(\''.$row['MaViecLam'].'\', \''.$_SESSION['emailDangNhap'].'\')">
						...
						echo '
							<button style="width: 200px;" class="button button-reset" onclick="moCuaSo(\'login-frame\', \'nen-cua-so-dang-nhap\')">
								<span class="material-symbols-outlined icon1" style="">playlist_add
								</span>
								Quan tâm
							</button>
						';
